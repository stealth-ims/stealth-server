...
export class CreateSupplierDto extends IntersectionType(GenericResponseDto) {
  ...
  @ApiProperty({ example: "John Doe", description: "Name of person to contact" })
  @IsString()
  @IsNotEmpty()
  contactPerson: string;

  @ApiProperty({ example: "Sales Manager", description: "Position of contact person" })
  @IsString()
  @IsNotEmpty()
  position: string

  @ApiProperty({ example: "0592785415", description: "phone number of person to contact" })
  @IsString()
  @MinLength(10)
  contact: string;
